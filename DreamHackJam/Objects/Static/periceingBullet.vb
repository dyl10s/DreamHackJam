Public Class periceingBullet
    ...
    Public Sub New(ByRef shootTarget As Vector2, startPos As Vector2, shotRange As Integer)
        ...
        colbox = New collisionBox(realPos, size, "bullet2")
    ...
    Public Sub destroy()
        ...
        Game1.gameLoop.gameScene.peirceingBullets.Remove(Me)
